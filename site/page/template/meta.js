...
module.exports = class Meta {
  build(route) {
    const isArticle = route.includes('/article/') || route.endsWith('/staff');
    ...
    return html`
      ...
      <meta content="${siteName}" property="og:site_name" id="meta-site-name"/>
      ...
      <link rel="apple-touch-icon" sizes="192x192"
            href="/res/img/common/icon-192.png" />
